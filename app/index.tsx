...
const HomeScreen = () => {
  ...
  return (
    <ScrollView>
      ...
      <Text>HomeScreen [Menu Provided By Christoffel's Restaurant]</Text>
        ...
        {menuList.map(menu => {
          return (
            <View key={menu.id} style={styles.menuDisplayBox}>
              ...
              <Text style={{ fontSize: 10, fontWeight: 'bold', fontStyle: 'normal', color: 'lavender' }}>{menu.name}</Text>
              <Text style={{ fontSize: 10, fontWeight: 'bold', fontStyle: 'normal', color: 'lavender' }}>{menu.description}</Text>
              <Text style={{ fontSize: 10, fontWeight: 'bold', fontStyle: 'normal', color: 'lavender' }}>{menu.price}</Text>
            </View>
          )
        })}
      </View>
